...
namespace MigrationsProducts.Migrations
{
    [DbContext(typeof(CommodityContext))]
    partial class MigrationsCommodity : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commodity.Models.ImportOrderDetail", b =>
                {
                    b.Property<int>("ImportOrderDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ImportOrderDetailId"));
                    ...
                    b.HasKey("ImportOrderDetailId");

                    b.HasIndex("ImportOrderId");

                    b.HasIndex("ProductId");

                    b.ToTable("ImportOrderDetail");
                });
            ...
            modelBuilder.Entity("Commodity.Models.ImportOrderDetail", b =>
                {
                    b.HasOne("Commodity.Models.ImportOrder", "ImportOrder")
                        .WithMany()
                        .HasForeignKey("ImportOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Commodity.Models.Product", "Product")
                        .WithMany()
